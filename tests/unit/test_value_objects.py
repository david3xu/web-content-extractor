...
class TestSourceUrl:
    ...
    def test_from_string_with_www(self):
...
class TestProcessingTime:
    ...
    def test_invalid_processing_time_zero(self):
...
class TestCorrelationId:
    ...
    def test_invalid_correlation_id_short(self):
        """Test invalid correlation ID raises error."""
        with pytest.raises(ValueError, match="Correlation ID must be at least 8 characters"):
            CorrelationId("short")

    def test_invalid_correlation_id_empty(self):
